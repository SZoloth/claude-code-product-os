...
export class ExcelExporter {
  ...
  private static getEventsSheetFormatting() {
    return {
      headerRow: { font: { bold: true, color: '#FFFFFF' }, fill: { bgColor: '#4472C4' } },
      dataValidation: {
  ...
  private static getPropertiesSheetFormatting() {
    return {
      headerRow: { font: { bold: true, color: '#FFFFFF' }, fill: { bgColor: '#70AD47' } },
  ...
  private static getValidationSheetFormatting() {
    return {
      headerRow: { font: { bold: true, color: '#FFFFFF' }, fill: { bgColor: '#C5504B' } },
      conditionalFormatting: {
        'C:C': {
